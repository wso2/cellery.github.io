...
<div class="row cBallerina-io-Gray-row">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 cDownloadsHeader">       
                <div class="cFeaturedVersion">
                    <h2>Current version: <span id="versionInfo">0.2.1 (May 22, 2019)</span></h2>
                </div>
            </div>
        </div>
        ...
        <div class="row cDownloads">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 cDownloadMiddle">
                <a id="packLinux" href="https://product-dist.cellery.io/downloads/0.2.1/cellery-ubuntu-x64-0.2.1.deb" 
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 cDownloadMiddle">
                <a id="packMac" href="https://product-dist.cellery.io/downloads/0.2.1/cellery-macos-installer-x64-0.2.1.pkg" class="cDownload" data-download="downloads" data-pack="">
                    <div>MacOS</div>
        ...
        <div class="col-xs-12 col-sm-16 col-md-12 col-lg-12">
            <div class="cStandaloneInstallers">
                ...
                <div class="cInstallers" style="width:100%;">
                    <h3 class="release-version">Stable <span id="stableInfo">(May 22, 2019)</span></h3>
    ...
    <tr>
        <td style="width: 96%">cellery-ubuntu-x64-0.2.1.deb</td>
        <td style="width: 1%; white-space: nowrap;">
            <a href="https://product-dist.cellery.io/downloads/0.2.1/cellery-ubuntu-x64-0.2.1.deb" class="cDownloadLinkIcon"><img src="../img/download-bg-green-fill.svg"></a>
        </td>
   ...
   <tr>
        <td style="width: 96%">cellery-macos-installer-x64-0.2.1.pkg</td>
        <td style="width: 1%; white-space: nowrap;">
            <a href="https://product-dist.cellery.io/downloads/0.2.1/cellery-macos-installer-x64-0.2.1.pkg" class="cDownloadLinkIcon" data-download="downloads" data-pack=""><img src="../img/download-bg-green-fill.svg"></a>
        </td>
        <!-- <td style="width: 1%; white-space: nowrap;"><a href="">md5</a></td>
